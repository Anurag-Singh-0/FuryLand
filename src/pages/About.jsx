            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 text-lg leading-relaxed mb-6">
                  Furyland was born from a vision to revolutionize online
                  shopping—bringing style, quality, and convenience directly to
                  you. We're committed to creating a platform where premium
                  products meet exceptional service.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <p className="text-gray-600 text-sm">
                    Every product is handpicked from trusted brands and emerging
                    creators.
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <p className="text-gray-600 text-sm">
                    Your satisfaction drives everything we do, from selection to
                    delivery.
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600">
                Every product undergoes rigorous quality checks. We partner only
                with trusted brands and artisans who share our commitment to
                excellence.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600">
                Shop with confidence using our secure payment gateway. Your data
                is protected with enterprise-grade encryption and privacy
                measures.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600">
                Enjoy free shipping on orders over ₹1999. Our efficient
                logistics ensure your orders reach you quickly and safely,
                anywhere in India.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600">
                ...
                pre-purchase queries to after-sales support, we're here for you.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600">
                Not satisfied? We offer a hassle-free 30-day return policy. Your
                satisfaction is guaranteed with our simple and transparent
                return process.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600">
                Get personalized recommendations and styling advice from our
                fashion experts. We help you find exactly what you're looking
                for.
              </p>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
            Join thousands of satisfied customers who trust Furyland for their
            fashion needs.
          </p>
