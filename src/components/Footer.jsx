...
function Footer() {
  return (
    <div className="mt-20">
      <div className="flex justify-between flex-col lg:flex-row gap-8 mb-8">
        <div className="flex flex-col w-full gap-3 lg:w-[40%]">
          ...
          <p className="text-gray-600">
            ...
            Praesentium, nostrum excepturi ut cupiditate quas in enim dolore a
            minus repellat.
          </p>
        </div>
      ...
      <p className="text-center text-[0.8rem] m-5">&copy; {new Date().getFullYear()} Furyland - All rights reserved.</p>
    </div>
  );
}
