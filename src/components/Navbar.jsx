    ...
    <>
      <motion.div
        ...
        className={`sticky top-0 left-0 right-0 z-50 transition-all duration-500 ease-out ${
          isScrolled
            ? "bg-white/30 backdrop-blur-md shadow-sm mx-4 mt-4 rounded-full px-6 py-3"
            : "bg-transparent py-5"
        }`}
        style={{
          marginLeft: isScrolled ? "16px" : "0",
          marginRight: isScrolled ? "16px" : "0",
            ...
            <Link to="/">
              <motion.img
                ...
                className={`logo transition-all duration-500 ${
                  isScrolled ? "w-28 md:w-32 lg:w-36" : "w-32 md:w-40 lg:w-48"
                }`}
                alt="logo"
                ...
                <div className="relative">
                  <input
                    ...
                    className={`transition-all duration-500 ${
                      isScrolled
                        ? "w-56 px-4 py-2 pl-10 bg-gray-50 border border-gray-200 rounded-full focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent"
                        : "w-64 px-4 py-2 pl-10 bg-gray-50 border border-gray-200 rounded-full focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent"
                    }`}
                  />
